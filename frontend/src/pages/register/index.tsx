...
const RegisterationSteps = [
    {
        ...
        subtitle:
            "Create your own unique identity that will help recognize and share your portfolio over the your network, we call it Turf-ID.",
        component: <Identity />,
    },
    // {
    //     id: 1,
        ...
        >
            <Layout>
                ...
                {/* <Card
                    ...
                    animate={{
                        top:
                            currentStep === 1 ? 12 : currentStep === 2 ? 0 : 20,
                        width:
                            currentStep === 1
                                ? "90%"
                                : currentStep === 2
